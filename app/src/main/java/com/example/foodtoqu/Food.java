...
public class Food {
    ...
    public Food(String foodId, String foodName, String calorie, String totalFat, String cholesterol, String sodium, String carbo, String totalSugar, String protein, String imageUrl, Map<String, Boolean> healthConditions, Map<String, Boolean> moods) {
        this.foodId = foodId;
