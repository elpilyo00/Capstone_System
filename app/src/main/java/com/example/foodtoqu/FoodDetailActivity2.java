...
public class FoodDetailActivity2 extends AppCompatActivity {
    ...
    private TextView detailTitle, detailCalorie, detailFat, detailCholesterol,
            detailSodium, detailCarbo, detailSugar, detailProtein;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailCalorie.setText("Calorie: " + calorie);
        detailFat.setText("Total Fat: " + totalFat);
        detailCholesterol.setText("Cholesterol: " + cholesterol);
        detailSodium.setText("Sodium: " + sodium);
        detailCarbo.setText("Total Carbohydrate: " + carbo);
        detailSugar.setText("Total Sugar: " + totalSugar);
        detailProtein.setText("Protein: " + protein);
